...
if app_mode=='Home':    
    ...
    st.bar_chart(data[['ApplicantIncome','LoanAmount']].head(20), color= ['#845EC2', '#D65DB1'])


elif app_mode == 'Prediction':    
    # st.image('slider-short-3.jpg')    
    st.subheader('Ola! Please fill out the form to see if the bank will likely to approve your loan or not:')    
    ...
    feature_list=[
        ...
        ,get_fvalue(Married)
        ,data1['Dependents'][0],data1['Dependents'][1]
